...
export default function ForgotPassword() {
  ...
  return <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-slate-950">
    <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className="mb-6 flex flex-col items-center"><Link to="/"><img src={logo} alt="NalarASN" className="mb-3 h-12 w-auto max-w-[210px] object-contain" /></Link><h1 className="text-lg font-bold">Reset Password</h1><p className="mt-2 text-center text-sm text-gray-600 dark:text-slate-300">Firebase akan mengirim tautan reset ke email akun kamu.</p></div>
